...
void GameStart::DealData()
{
    ...
    if(!gaming_IsHard)
    {
        rivalScore+=userInf[gaming_rival].TBE[keyGroup].tx;
        rivalHorseX+=userInf[gaming_rival].TBE[keyGroup].mx;
    }
    else
    {
        rivalScore+=userInf[gaming_rival].TBH[keyGroup].tx;
        rivalHorseX+=userInf[gaming_rival].TBH[keyGroup].mx;
    }
